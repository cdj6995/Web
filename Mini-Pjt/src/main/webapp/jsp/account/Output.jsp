	...
	<section>
		<div class="container-fluid page-header py-5 my-3 mt-0 wow fadeIn" data-wow-delay="0.1s">
	        <div class="container text-center">
	            <h1 class="display-3 text-white animated slideInDown mb-4">출금</h1>
	        </div>
	    </div>
	        ...
	        <div class="container">
	            <div class="row g-5">
	                <div class="col-lg-6 wow fadeInUp text-center my-5" data-wow-delay="0.5s">
			           <h1 class="display-6 mb-4">출금하기</h1>
			           <form action="${ pageContext.request.contextPath }/accountOutputProcess.do" method="post" name="signup" onsubmit="return checkForm()">
			               <div class="row g-3">
			               	   <div class="col-md-12">
			                   ...
			                   <div class="col-12">
			                       <button class="btn btn-primary py-3 px-5" type="submit">출금하기</button>
			                   </div>
			               </div>
			           </form>
			       </div>
