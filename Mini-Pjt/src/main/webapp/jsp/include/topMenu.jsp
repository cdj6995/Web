        ...
        <div class="row gx-0 d-none d-lg-flex">
            <div class="col-lg-7 px-5 text-start">
                <div class="h-100 d-inline-flex align-items-center me-4">
                    ...
                    <small>data analysis, Ploytech</small>
                </div>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="${ pageContext.request.contextPath }/accountSelect.do" class="nav-item nav-link">계좌조회</a>
                <a href="${ pageContext.request.contextPath }/transfer.do" class="nav-item nav-link">계좌이체</a>
                <c:choose>
                	<c:when test="${ not empty userVO }">
		                <a href="${ pageContext.request.contextPath }/makeAccount.do" class="nav-item nav-link">계좌개설</a>                	
                	</c:when>
                </c:choose>
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">금융상품</a>
                    <div class="dropdown-menu bg-light m-0">
                        <a href="" class="dropdown-item">예금</a>
                        <a href="" class="dropdown-item">대출</a>
                        <a href="" class="dropdown-item">보험</a>
                        <a href="" class="dropdown-item">펀드</a>
                    </div>
                </div>
